            ...
            while ($data = mysqli_fetch_array($sql)) {
                ...
                <div class="col-md-3">
                    <a type="button" data-bs-toggle="modal" data-bs-target="#komentar<?php echo $data['fotoid'] ?>">
                        <div class="card">
                            <img src="galeri/<?= $data['lokasifile'] ?>" class="card-img-top"
                                            ...
                                            <div class="m-2">
                                                <div class="overflow-auto">
                                                    <div class="sticky-top">
                                                        ...
                                                        <p>Pengunggah Gambar : <span class="badge bg-secondary">
                                                                <?php echo $data['namalengkap'] ?>
                                                            </span></p>
                                                        <p>Tanggal Unggah : <span class="badge bg-secondary">
                                                                <?php echo $data['tanggalunggah'] ?>
                                                            </span></p>
                                                        <p>Nama Album : <span class="badge bg-primary">
